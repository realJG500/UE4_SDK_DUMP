...
public:
	...
	unsigned char                                      UnknownData02[0x1];                                       // 0x3BF8(0x0001) UNKNOWN PROPERTY: EnumProperty CharProxy_AnimBP.CharProxy_AnimBP_C.AnimWeaponType
	...
	class Vector3D                                     PistolOffset;                                             // 0x3C18(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0x1];                                       // 0x3C2C(0x0001) UNKNOWN PROPERTY: EnumProperty CharProxy_AnimBP.CharProxy_AnimBP_C.WeaponClassEnum
	...
	unsigned char                                      IsLobbyReady : 1;                                         // 0x3C50(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	class Vector3D                                     Wind;                                                     // 0x3C98(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	class Vector3D                                     InitialWind;                                              // 0x3CA4(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData04[0x1];                                       // 0x3CB8(0x0001) UNKNOWN PROPERTY: EnumProperty CharProxy_AnimBP.CharProxy_AnimBP_C.CameraState
	...
	unsigned char                                      bIsLobbyCharacterValid : 1;                               // 0x3CC8(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
