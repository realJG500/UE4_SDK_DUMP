...
public:
	...
	unsigned char                                      bSingleFile : 1;                                          // 0x0068(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bFileFound : 1;                                           // 0x0069(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bUnzipto : 1;                                             // 0x006A(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
