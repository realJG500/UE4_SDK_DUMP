...
// (FUNC_Public, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// class Vector2D                 AdditionalPos                  (CPF_Parm, CPF_IsPlainOldData)
...
// Parameters:
// class Vector2D                 Position                       (CPF_Parm, CPF_IsPlainOldData)
// class Vector2D                 LeftTop                        (CPF_Parm, CPF_OutParm, CPF_IsPlainOldData)
// class Vector2D                 RightBottom                    (CPF_Parm, CPF_OutParm, CPF_IsPlainOldData)
...
// (FUNC_Public, FUNC_HasOutParms, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent, FUNC_BlueprintPure, FUNC_Const)
// Parameters:
// class Vector2D                 Alignment                      (CPF_Parm, CPF_OutParm, CPF_IsPlainOldData)
...
// (FUNC_Public, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// class Vector2D                 Aligment                       (CPF_Parm, CPF_IsPlainOldData)
...
// Parameters:
// class Vector2D                 Position                       (CPF_Parm, CPF_IsPlainOldData)
// class Vector2D                 ConvertedPosition              (CPF_Parm, CPF_OutParm, CPF_IsPlainOldData)
...
// (FUNC_Public, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// class Vector2D                 MapSize                        (CPF_Parm, CPF_IsPlainOldData)
...
// class Vector2D                 MapSize                        (CPF_Parm, CPF_OutParm, CPF_IsPlainOldData)
