...
void UQualitySettingsWidget_C::UpdateOtionStringByUserStting()
{
...
void UQualitySettingsWidget_C::GetComboBox(class UQualityComboBox_C** ComboBox)
{
...
void UQualitySettingsWidget_C::SetQualityLevelByComboBox()
{
...
void UQualitySettingsWidget_C::GetQualityLevelByComboBox(int* QualityLevel)
{
