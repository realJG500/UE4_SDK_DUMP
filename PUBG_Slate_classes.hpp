...
{
public:
	unsigned char                                      bVirtualKeyboardSendsTextChanged : 1;                     // 0x0028(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      bVirtualKeyboardDisplayOnFocus : 1;                       // 0x0029(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      bExplicitCanvasChildZOrder : 1;                           // 0x002A(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
