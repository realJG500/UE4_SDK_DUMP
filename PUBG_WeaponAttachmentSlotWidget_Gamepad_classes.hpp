...
public:
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0388(0x0001) UNKNOWN PROPERTY: EnumProperty WeaponAttachmentSlotWidget_Gamepad.WeaponAttachmentSlotWidget_Gamepad_C.AttachmentSlotID
	...
	unsigned char                                      bWantFocus : 1;                                           // 0x03A8(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bSelfAttachFocus : 1;                                     // 0x03A9(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bSelfAttachmentPutFocus : 1;                              // 0x03AA(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	unsigned char                                      bSubFocus : 1;                                            // 0x03D0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
