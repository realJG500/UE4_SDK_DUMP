...
namespace Classes
{
	...
	public:
		...
		unsigned char                                      UnknownData06[0x28];                                      // 0x0618(0x0028) MISSED OFFSET
		...
		unsigned char                                      UnknownData07[0x10];                                      // 0x0660(0x0010) MISSED OFFSET
		class UGameEventObserver*                          GameEventObserver;                                        // 0x0670(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData08[0x28];                                      // 0x0678(0x0028) MISSED OFFSET
		struct FTslReplaySummary                           ReplaySummaryForPlayback;                                 // 0x06A0(0x0080) (CPF_BlueprintVisible, CPF_BlueprintReadOnly)
		struct FScriptMulticastDelegate                    OnGetReplaySummaryDone;                                   // 0x0720(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		unsigned char                                      bIsStartedFromReplayListMap : 1;                          // 0x0730(0x0001) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class ATslPlayerState*                             CachedDemoPlayerState;                                    // 0x0738(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData09[0x140];                                     // 0x0740(0x0140) MISSED OFFSET
		class UHighlightSession*                           HighlightSession;                                         // 0x0880(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData10[0xE8];                                      // 0x0888(0x00E8) MISSED OFFSET
