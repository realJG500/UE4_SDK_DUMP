...
public:
	...
	unsigned char                                      bMouseDown : 1;                                           // 0x0318(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bRollBackMosueIVsibility : 1;                             // 0x0319(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	class Vector2D                                     MouseDownPosition;                                        // 0x031C(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bMouseOn : 1;                                             // 0x0324(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	unsigned char                                      bWantFocus : 1;                                           // 0x0350(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	unsigned char                                      bScrollUp : 1;                                            // 0x037C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      bScrollDown : 1;                                          // 0x037D(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x03B0(0x0001) UNKNOWN PROPERTY: EnumProperty EquipmentWidget_Gamepad.EquipmentWidget_Gamepad_C.FocusSlotID
	...
	unsigned char                                      bScrollUpdated : 1;                                       // 0x03D8(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	void GetItemByEquipSlotId(class UInventorySlotBaseWidget_C** Array_Element);
	void SaveFocusSlotId();
