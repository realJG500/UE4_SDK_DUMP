...
struct FAnimNode_RigidBody : public FAnimNode_SkeletalControlBase
{
	...
	class Vector3D                                     OverrideWorldGravity;                                     // 0x0078(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     OverlapChannel;                                           // 0x0084(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bEnableWorldGeometry : 1;                                 // 0x0085(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bComponentSpaceSimulation : 1;                            // 0x0086(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bOverrideWorldGravity : 1;                                // 0x0087(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
