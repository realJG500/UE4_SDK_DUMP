...
public:
	...
	TArray<unsigned char>                              TirePunctured;                                            // 0x0270(0x0010) (CPF_Net, CPF_ZeroConstructor, CPF_Transient)
	...
	unsigned char                                      bReverseAsBrake : 1;                                      // 0x02A0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	class Vector3D                                     InertiaTensorScale;                                       // 0x02B4(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	...
	class Vector3D                                     PendingLaunchVelocity;                                    // 0x0334(0x000C) (CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x2B];                                      // 0x03A5(0x002B) MISSED OFFSET
...
public:
	...
	class Vector3D                                     Offset;                                                   // 0x0034(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	...
	class Vector3D                                     SuspensionTravelDir;                                      // 0x007C(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	class Vector3D                                     TireForceOffset;                                          // 0x0088(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	...
	class Vector3D                                     Location;                                                 // 0x00D8(0x000C) (CPF_Transient, CPF_IsPlainOldData)
	class Vector3D                                     OldLocation;                                              // 0x00E4(0x000C) (CPF_Transient, CPF_IsPlainOldData)
	class Vector3D                                     Velocity;                                                 // 0x00F0(0x000C) (CPF_Transient, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bUseSupsensionInterpolation : 1;                          // 0x0878(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
