...
void UMessageHudWidget_C::OnDisplayMessage(const struct FText& Message, float Duration, class UAkAudioEvent* Sound)
{
...
void UMessageHudWidget_C::OnDisplaySystemMessage(const struct FText& Message)
{
