...
void UKickPopupWidget_C::SetPopup(const struct FText& Message, const struct FScriptDelegate& PressedDelegate)
{
...
void UKickPopupWidget_C::ButttonClick__DelegateSignature()
{
