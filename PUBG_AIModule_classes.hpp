...
public:
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0818(0x0001) UNKNOWN PROPERTY: EnumProperty AIModule.EQSTestingPawn.HighlightMode
	...
	unsigned char                                      UnknownData02[0x2F];                                      // 0x0821(0x002F) MISSED OFFSET
...
public:
	...
	bool STATIC_FindLocalNavigationGridPath(class UObject* WorldContext, const class Vector3D& Start, const class Vector3D& End, TArray<class Vector3D>* PathPoints);
	int STATIC_AddLocalNavigationGridForPoints(class UObject* WorldContext, TArray<class Vector3D> Locations, int Radius2D, float Height, bool bRebuildGrids);
	int STATIC_AddLocalNavigationGridForPoint(class UObject* WorldContext, const class Vector3D& Location, int Radius2D, float Height, bool bRebuildGrids);
	int STATIC_AddLocalNavigationGridForCapsule(class UObject* WorldContext, const class Vector3D& Location, float CapsuleRadius, float CapsuleHalfHeight, int Radius2D, float Height, bool bRebuildGrids);
	int STATIC_AddLocalNavigationGridForBox(class UObject* WorldContext, const class Vector3D& Location, const class Vector3D& Extent, const class Rotator& Rotation, int Radius2D, float Height, bool bRebuildGrids);
};
...
{
public:
	class Vector3D                                     CrowdAgentMoveDirection;                                  // 0x0490(0x000C) (CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData00[0x2C];                                      // 0x04B4(0x002C) MISSED OFFSET
...
public:
	...
	class Vector3D                                     GoalLocation;                                             // 0x00D8(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
