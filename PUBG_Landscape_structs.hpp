...
{
	class Vector3D                                     Center;                                                   // 0x0000(0x000C) (CPF_IsPlainOldData)
	class Vector3D                                     Left;                                                     // 0x000C(0x000C) (CPF_IsPlainOldData)
	class Vector3D                                     Right;                                                    // 0x0018(0x000C) (CPF_IsPlainOldData)
	class Vector3D                                     FalloffLeft;                                              // 0x0024(0x000C) (CPF_IsPlainOldData)
	class Vector3D                                     FalloffRight;                                             // 0x0030(0x000C) (CPF_IsPlainOldData)
...
struct FLayerBlendInput
{
	...
	class Vector3D                                     ConstLayerInput;                                          // 0x0084(0x000C) (CPF_Edit, CPF_IsPlainOldData)
...
struct FLandscapeSplineMeshEntry
{
	...
	class Vector2D                                     CenterAdjust;                                             // 0x001C(0x0008) (CPF_Edit, CPF_IsPlainOldData)
	unsigned char                                      bScaleToWidth : 1;                                        // 0x0024(0x0001) (CPF_Edit)
	class Vector3D                                     Scale;                                                    // 0x0028(0x000C) (CPF_Edit, CPF_IsPlainOldData)
