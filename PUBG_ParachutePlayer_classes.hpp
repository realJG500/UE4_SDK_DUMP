...
public:
	...
	class UTimelineComponent*                          АР„З|·xЗ_1;                                               // 0x05E8(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      isDebug : 1;                                              // 0x0600(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	class Vector2D                                     TestCoord_Start;                                          // 0x0618(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	class Vector2D                                     TestCoord_End;                                            // 0x0620(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	class Vector3D                                     LastVelocity;                                             // 0x0664(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
