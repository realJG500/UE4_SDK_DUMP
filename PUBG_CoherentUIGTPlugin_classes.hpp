...
public:
	...
	unsigned char                                      UnknownData02[0x20B];                                     // 0x026D(0x020B) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x17];                                      // 0x0509(0x0017) MISSED OFFSET
...
public:
	...
	unsigned char                                      bRecursivelyBindUStructs : 1;                             // 0x0037(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      AllowPerformanceWarningsInEditor : 1;                     // 0x0038(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      ShowWarningsOnScreen : 1;                                 // 0x0039(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x003A(0x0001) UNKNOWN PROPERTY: EnumProperty CoherentUIGTPlugin.CoherentUIGTSettings.LogSeverity
	unsigned char                                      bRespectTitleSafeZone : 1;                                // 0x003B(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      bRespectLetterboxing : 1;                                 // 0x003C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0061(0x0001) UNKNOWN PROPERTY: EnumProperty CoherentUIGTPlugin.CoherentUIGTSettings.MSAA
