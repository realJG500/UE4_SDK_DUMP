...
{
	unsigned char                                      UnknownData00[0x1];                                       // 0x0000(0x0001) UNKNOWN PROPERTY: EnumProperty AudioMixer.SubmixEffectDynamicsProcessorSettings.DynamicsProcessorType
	unsigned char                                      UnknownData01[0x1];                                       // 0x0001(0x0001) UNKNOWN PROPERTY: EnumProperty AudioMixer.SubmixEffectDynamicsProcessorSettings.PeakMode
