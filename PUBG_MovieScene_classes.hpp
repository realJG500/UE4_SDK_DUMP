...
public:
	...
	unsigned char                                      UnknownData02[0x308];                                     // 0x03F8(0x0308) MISSED OFFSET
...
public:
	...
	unsigned char                                      bParentContextsAreSignificant : 1;                        // 0x0328(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
