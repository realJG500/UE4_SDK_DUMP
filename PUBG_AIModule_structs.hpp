...
struct FAIDamageEvent
{
	...
	class Vector3D                                     Location;                                                 // 0x0004(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	class Vector3D                                     HitLocation;                                              // 0x0010(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
...
{
	class Vector3D                                     NoiseLocation;                                            // 0x0004(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
...
struct FEnvOverlapData
{
	...
	class Vector3D                                     ShapeOffset;                                              // 0x000C(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
...
struct FAIStimulus
{
	...
	class Vector3D                                     StimulusLocation;                                         // 0x000C(0x000C) (CPF_BlueprintVisible, CPF_IsPlainOldData)
	class Vector3D                                     ReceiverLocation;                                         // 0x0018(0x000C) (CPF_BlueprintVisible, CPF_IsPlainOldData)
