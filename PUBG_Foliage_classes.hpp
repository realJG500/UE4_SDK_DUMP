...
public:
	...
	class Vector3D                                     CollisionScale;                                           // 0x00E4(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	...
	class Vector3D                                     LowBoundOriginRadius;                                     // 0x0110(0x000C) (CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0xA];                                       // 0x0446(0x000A) MISSED OFFSET
...
public:
	...
	class Vector3D                                     TouchingActorEntryPosition;                               // 0x03C8(0x000C) (CPF_Transient, CPF_IsPlainOldData)
	class Vector3D                                     FoliageVelocity;                                          // 0x03D4(0x000C) (CPF_Transient, CPF_IsPlainOldData)
	class Vector3D                                     FoliageForce;                                             // 0x03E0(0x000C) (CPF_Transient, CPF_IsPlainOldData)
	class Vector3D                                     FoliagePosition;                                          // 0x03EC(0x000C) (CPF_Transient, CPF_IsPlainOldData)
