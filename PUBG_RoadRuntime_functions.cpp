...
// class Vector3D                 MeshRelativeLocation           (CPF_Parm, CPF_IsPlainOldData)
// class Rotator                  MeshRelativeRotation           (CPF_Parm, CPF_IsPlainOldData)
// class Vector3D                 MeshRelativeScale              (CPF_Parm, CPF_IsPlainOldData)
...
void ACrossActor::UpdateSideMesh(class UStaticMesh* InPrototype, const class Vector3D& MeshRelativeLocation, const class Rotator& MeshRelativeRotation, const class Vector3D& MeshRelativeScale, int SocketIndex, bool IsEnable, bool IsNormalized)
{
...
// class Vector3D                 ActorRelativeLocation          (CPF_Parm, CPF_IsPlainOldData)
// class Rotator                  ActorRelativeRotation          (CPF_Parm, CPF_IsPlainOldData)
// class Vector3D                 ActorRelativeScale             (CPF_Parm, CPF_IsPlainOldData)
// int                            SocketIndex                    (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
// bool                           IsEnable                       (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
// bool                           IsNormalized                   (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)

void ACrossActor::UpdateSideActor(class UClass* InPrototype, const class Vector3D& ActorRelativeLocation, const class Rotator& ActorRelativeRotation, const class Vector3D& ActorRelativeScale, int SocketIndex, bool IsEnable, bool IsNormalized)
{
...
void ACrossActor::PushSideMesh(class UStaticMesh* InPrototype, const class Vector3D& MeshRelativeLocation, const class Rotator& MeshRelativeRotation, const class Vector3D& MeshRelativeScale, int SocketIndex, bool IsEnable, bool IsNormalized)
{
...
void ACrossActor::PushSideActor(class UClass* InPrototype, const class Vector3D& ActorRelativeLocation, const class Rotator& ActorRelativeRotation, const class Vector3D& ActorRelativeScale, int SocketIndex, bool IsEnable, bool IsNormalized)
{
...
void ARoadActor::UpdateSideMeshes(class UStaticMesh* InPrototype, const class Vector3D& MeshRelativeLocation, const class Rotator& MeshRelativeRotation, const class Vector3D& MeshRelativeScale, int SocketIndex, int InShift, int InSpacing, bool IsEnable, bool IsNormalized)
{
...
void ARoadActor::UpdateSideActor(class UClass* InPrototype, const class Vector3D& ActorRelativeLocation, const class Rotator& ActorRelativeRotation, const class Vector3D& ActorRelativeScale, int SocketIndex, int InShift, int InSpacing, bool IsEnable, bool IsNormalized)
{
...
void ARoadActor::PushSideMesh(class UStaticMesh* InPrototype, const class Vector3D& MeshRelativeLocation, const class Rotator& MeshRelativeRotation, const class Vector3D& MeshRelativeScale, int SocketIndex, int InShift, int InSpacing, bool IsEnable, bool IsNormalized)
{
...
void ARoadActor::PushSideActor(class UClass* InPrototype, const class Vector3D& ActorRelativeLocation, const class Rotator& ActorRelativeRotation, const class Vector3D& ActorRelativeScale, int SocketIndex, int InShift, int InSpacing, bool IsEnable, bool IsNormalized)
{
...
void ARoadActor::PushCurbsMeshes(class UStaticMesh* InPrototype, class UStaticMesh* InStartPrototype, class UStaticMesh* InEndPrototype, const class Vector3D& MeshRelativeLocation, const class Vector3D& MeshRelativeScale, int SocketIndex, bool IsEnable, bool InStartEnable, bool InEndEnable)
{
