...
public:
	...
	unsigned char                                      bUseComplexAsSimpleCollision : 1;                         // 0x0958(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	void STATIC_SliceProceduralMesh(class UProceduralMeshComponent* InProcMesh, const class Vector3D& PlanePosition, const class Vector3D& PlaneNormal, bool bCreateOtherHalf, class UMaterialInterface* CapMaterial, class UProceduralMeshComponent** OutOtherHalfProcMesh);
