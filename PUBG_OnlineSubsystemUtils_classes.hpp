...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0438(0x0001) (CPF_Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0438(0x0001) (CPF_Config)
	uint32_t                                           MaxPortCountToTry;                                        // 0x043C(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x18];                                      // 0x0440(0x0018) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x0458(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x045C(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x0460(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x0464(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x03E8(0x0001) UNKNOWN PROPERTY: EnumProperty OnlineSubsystemUtils.OnlineBeaconClient.ConnectionState
	unsigned char                                      UnknownData01[0x77];                                      // 0x03E9(0x0077) MISSED OFFSET
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x0520(0x0010) (CPF_ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0530(0x0030)
	unsigned char                                      UnknownData01[0x1];                                       // 0x0560(0x0001) UNKNOWN PROPERTY: EnumProperty OnlineSubsystemUtils.PartyBeaconClient.RequestType
	unsigned char                                      bPendingReservationSent : 1;                              // 0x0561(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bCancelReservation : 1;                                   // 0x0562(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x2D];                                      // 0x0563(0x002D) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0xA0];                                      // 0x03F0(0x00A0) MISSED OFFSET
...
public:
	...
	unsigned char                                      bLogoutOnSessionTimeout : 1;                              // 0x0520(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
