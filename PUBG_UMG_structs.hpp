...
{
	class Vector2D                                     Translation;                                              // 0x0000(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	class Vector2D                                     Scale;                                                    // 0x0008(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	class Vector2D                                     Shear;                                                    // 0x0010(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
...
{
	class Vector2D                                     Position;                                                 // 0x0000(0x0008) (CPF_IsPlainOldData)
	struct FColor                                      Color;                                                    // 0x0008(0x0004) (CPF_IsPlainOldData)
	class Vector2D                                     UV0;                                                      // 0x000C(0x0008) (CPF_IsPlainOldData)
	class Vector2D                                     UV1;                                                      // 0x0014(0x0008) (CPF_IsPlainOldData)
	class Vector2D                                     UV2;                                                      // 0x001C(0x0008) (CPF_IsPlainOldData)
	class Vector2D                                     UV3;                                                      // 0x0024(0x0008) (CPF_IsPlainOldData)
	class Vector2D                                     UV4;                                                      // 0x002C(0x0008) (CPF_IsPlainOldData)
	class Vector2D                                     UV5;                                                      // 0x0034(0x0008) (CPF_IsPlainOldData)
};
...
struct FAnchorData
{
	...
	class Vector2D                                     Alignment;                                                // 0x0020(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
};
