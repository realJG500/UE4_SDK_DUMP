...
public:
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x00A0(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.Widget.Visiblity
	unsigned char                                      UnknownData01[0x1];                                       // 0x00A1(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.Widget.Visibility
	...
	unsigned char                                      bIsVolatile : 1;                                          // 0x00BD(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FWidgetTransform                            RenderTransform;                                          // 0x00C0(0x001C) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
	class Vector2D                                     RenderTransformPivot;                                     // 0x00DC(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x28];                                      // 0x00F0(0x0028) MISSED OFFSET
...
public:
	...
	unsigned char                                      bSupportsKeyboardFocus : 1;                               // 0x0198(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bIsFocusable : 1;                                         // 0x0199(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bStopAction : 1;                                          // 0x01C0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x50];                                      // 0x01F0(0x0050) MISSED OFFSET
	...
	class Vector2D GetAlignmentInViewport();
	void Destruct();
	void Construct();
...
public:
	...
	class Vector2D                                     Offset;                                                   // 0x004C(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
...
public:
	...
	void STATIC_ScreenToViewport(class UObject* WorldContextObject, const class Vector2D& ScreenPosition, class Vector2D* ViewportPosition);
...
public:
	...
	class Vector2D                                     ExtentMin;                                                // 0x0050(0x0008) (CPF_IsPlainOldData)
	class Vector2D                                     ExtentMax;                                                // 0x0058(0x0008) (CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bAllowTemplate : 1;                                       // 0x0360(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bValidTemplate : 1;                                       // 0x0398(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bTemplateInitialized : 1;                                 // 0x0399(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bCookedTemplate : 1;                                      // 0x039A(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
...
public:
	...
	class Vector2D                                     Nudge;                                                    // 0x0060(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0068(0x0008) MISSED OFFSET
...
{
public:
	unsigned char                                      bDoubleClickTogglesFullscreen : 1;                        // 0x0140(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bEnableRadius : 1;                                        // 0x01D0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x01D1(0x0017) MISSED OFFSET
...
public:
	...
	unsigned char                                      bIsFocusable : 1;                                         // 0x0148(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      HasDownArrow : 1;                                         // 0x0C9C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      EnableGamepadNavigationMode : 1;                          // 0x0C9D(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bIsFocusable : 1;                                         // 0x0D30(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData00[0x40];                                      // 0x0D68(0x0040) MISSED OFFSET
...
public:
	...
	unsigned char                                      AutoWrapText : 1;                                         // 0x0131(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0138(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.TextLayoutWidget.WrappingPolicy
...
public:
	...
	unsigned char                                      IsReadOnly : 1;                                           // 0x0470(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      IsPassword : 1;                                           // 0x0471(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MinimumDesiredWidth;                                      // 0x0474(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      IsCaretMovedWhenGainFocus : 1;                            // 0x0478(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      SelectAllTextWhenFocused : 1;                             // 0x0479(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      RevertTextOnEscape : 1;                                   // 0x047A(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      ClearKeyboardFocusOnCommit : 1;                           // 0x047B(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      SelectAllTextOnCommit : 1;                                // 0x047C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      AllowContextMenu : 1;                                     // 0x047D(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      IsReadOnly : 1;                                           // 0x0A88(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      IsPassword : 1;                                           // 0x0A89(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      IsCaretMovedWhenGainFocus : 1;                            // 0x0AA0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      SelectAllTextWhenFocused : 1;                             // 0x0AA1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      RevertTextOnEscape : 1;                                   // 0x0AA2(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      ClearKeyboardFocusOnCommit : 1;                           // 0x0AA3(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      SelectAllTextOnCommit : 1;                                // 0x0AA4(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      AllowContextMenu : 1;                                     // 0x0AA5(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bIsExpanded : 1;                                          // 0x0318(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bAllowModifierKeys : 1;                                   // 0x01E8(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bApplyAlphaToBlur : 1;                                    // 0x0152(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bOverrideAutoRadiusCalculation : 1;                       // 0x0158(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	class Vector2D                                     DesiredSizeScale;                                         // 0x0238(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
	unsigned char                                      bShowEffectWhenDisabled : 1;                              // 0x0240(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      IsFocusable : 1;                                          // 0x0412(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x1];                                       // 0x0140(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.CheckBox.CheckedState
	...
	unsigned char                                      IsFocusable : 1;                                          // 0x07C8(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	unsigned char                                      bCanCache : 1;                                            // 0x0140(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      CacheRelativeTransforms : 1;                              // 0x0141(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      ShouldDeferPaintingAfterWindowContent : 1;                // 0x0159(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UseApplicationMenuStack : 1;                              // 0x015A(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	unsigned char                                      PadLeft : 1;                                              // 0x0140(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      PadRight : 1;                                             // 0x0141(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      PadTop : 1;                                               // 0x0142(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      PadBottom : 1;                                            // 0x0143(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      IgnoreInheritedScale : 1;                                 // 0x0148(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x0149(0x0017) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x08B1(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.ScrollBox.ScrollBarVisibility
	unsigned char                                      UnknownData01[0x1];                                       // 0x08B2(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.ScrollBox.ConsumeMouseWheel
	class Vector2D                                     ScrollbarThickness;                                       // 0x08B4(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
	unsigned char                                      AlwaysShowScrollbar : 1;                                  // 0x08BC(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x1B];                                      // 0x08BD(0x001B) MISSED OFFSET
...
{
public:
	class Vector2D                                     InnerSlotPadding;                                         // 0x0140(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
	float                                              WrapWidth;                                                // 0x0148(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bExplicitWrapWidth : 1;                                   // 0x014C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bIsMarquee : 1;                                           // 0x0305(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bAlwaysShowScrollbar : 1;                                 // 0x0648(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EOrientation>                          Orientation;                                              // 0x0649(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	class Vector2D                                     Thickness;                                                // 0x064C(0x0008) (CPF_Edit, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x14];                                      // 0x0654(0x0014) MISSED OFFSET
...
public:
	...
	unsigned char                                      IndentHandle : 1;                                         // 0x03B4(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      Locked : 1;                                               // 0x03B5(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              StepSize;                                                 // 0x03B8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      IsFocusable : 1;                                          // 0x03BC(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class Vector2D                                     Size;                                                     // 0x0128(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      ClearKeyboardFocusOnCommit : 1;                           // 0x04CC(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      SelectAllTextOnCommit : 1;                                // 0x04CD(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bIsReadOnly : 1;                                          // 0x0398(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FSlateFontInfo                              Font;                                                     // 0x03A0(0x0068) (CPF_Deprecated)
	unsigned char                                      AllowContextMenu : 1;                                     // 0x0408(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bIsReadOnly : 1;                                          // 0x0C08(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      AllowContextMenu : 1;                                     // 0x0C09(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData00[0x10];                                      // 0x0CD0(0x0010) MISSED OFFSET
...
public:
	...
	class Vector2D                                     ShadowOffset;                                             // 0x0218(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
	...
	unsigned char                                      bWrapWithInvalidationPanel : 1;                           // 0x0244(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	int                                                NumberOfPieces;                                           // 0x0128(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bAnimateHorizontally : 1;                                 // 0x012C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bAnimateVertically : 1;                                   // 0x012D(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bAnimateOpacity : 1;                                      // 0x012E(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	bool STATIC_SetHardwareCursor(class UObject* WorldContextObject, TEnumAsByte<EMouseCursor> CursorShape, const struct FName& CursorName, const class Vector2D& HotSpot);
...
{
public:
	unsigned char                                      UnknownData00[0x1];                                       // 0x0950(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetComponent.Space
	unsigned char                                      UnknownData01[0x1];                                       // 0x0951(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetComponent.TimingPolicy
	...
	unsigned char                                      bManuallyRedraw : 1;                                      // 0x0968(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bRedrawRequested : 1;                                     // 0x0969(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bDrawAtDesiredSize : 1;                                   // 0x0980(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	class Vector2D                                     Pivot;                                                    // 0x0984(0x0008) (CPF_Edit, CPF_IsPlainOldData)
	unsigned char                                      bReceiveHardwareInput : 1;                                // 0x098C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bWindowFocusable : 1;                                     // 0x098D(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0x1];                                       // 0x09BC(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetComponent.BlendMode
	unsigned char                                      bIsTwoSided : 1;                                          // 0x09BD(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      TickWhenOffscreen : 1;                                    // 0x09BE(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData04[0x20];                                      // 0x09C8(0x0020) MISSED OFFSET
	...
	unsigned char                                      bAddedToScreen : 1;                                       // 0x0A30(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
	unsigned char                                      bEditTimeUsable : 1;                                      // 0x0A31(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData05[0x1];                                       // 0x0A44(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetComponent.GeometryMode
	float                                              CylinderArcAngle;                                         // 0x0A48(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData06[0x34];                                      // 0x0A4C(0x0034) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0420(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetInteractionComponent.InteractionSource
	unsigned char                                      bEnableHitTesting : 1;                                    // 0x0421(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bShowDebug : 1;                                           // 0x0422(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLinearColor                                DebugColor;                                               // 0x0424(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x7C];                                      // 0x0434(0x007C) MISSED OFFSET
	struct FHitResult                                  CustomHitResult;                                          // 0x04B0(0x0088) (CPF_Transient, CPF_IsPlainOldData)
	class Vector2D                                     LocalHitLocation;                                         // 0x0538(0x0008) (CPF_Transient, CPF_IsPlainOldData)
	class Vector2D                                     LastLocalHitLocation;                                     // 0x0540(0x0008) (CPF_Transient, CPF_IsPlainOldData)
	...
	unsigned char                                      bIsHoveredWidgetInteractable : 1;                         // 0x05D8(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bIsHoveredWidgetFocusable : 1;                            // 0x05D9(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bIsHoveredWidgetHitTestVisible : 1;                       // 0x05DA(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
