...
struct FSlateBrush
{
	...
	class Vector2D                                     ImageSize;                                                // 0x0008(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
...
struct FTextBlockStyle : public FSlateWidgetStyle
{
	struct FSlateFontInfo                              Font;                                                     // 0x0008(0x0068) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateColor                                 ColorAndOpacity;                                          // 0x0070(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	class Vector2D                                     ShadowOffset;                                             // 0x0098(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
