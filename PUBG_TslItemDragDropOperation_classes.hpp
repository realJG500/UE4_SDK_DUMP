...
public:
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x00B4(0x0001) UNKNOWN PROPERTY: EnumProperty TslItemDragDropOperation.TslItemDragDropOperation_C.MouseOverAttachmentSlotId
	...
	unsigned char                                      bIsMouseOverVicinity : 1;                                 // 0x00C0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bIsMouseOverInventory : 1;                                // 0x00C1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bIsMouseOverEquipment : 1;                                // 0x00C2(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bIsMouseOverWeaponEquipment : 1;                          // 0x00C3(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bIsMouseOverAttachmentSlot : 1;                           // 0x00C4(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x00EC(0x0001) UNKNOWN PROPERTY: EnumProperty TslItemDragDropOperation.TslItemDragDropOperation_C.MouseOverSlotId
