...
struct FMovieSceneCameraShakeSectionData
{
	...
	class Rotator                                      UserDefinedPlaySpace;                                     // 0x0010(0x000C) (CPF_Edit, CPF_IsPlainOldData)
};
...
{
	class Vector3D                                     Location;                                                 // 0x0008(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	class Rotator                                      Rotation;                                                 // 0x0014(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	class Vector3D                                     Scale;                                                    // 0x0020(0x000C) (CPF_Edit, CPF_IsPlainOldData)
...
{
	class Vector3D                                     Scale;                                                    // 0x0008(0x000C) (CPF_Edit, CPF_IsPlainOldData)
...
{
	class Rotator                                      Rotation;                                                 // 0x0008(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x1C];                                      // 0x0014(0x001C) MISSED OFFSET
};
...
{
	class Vector3D                                     Vector;                                                   // 0x0048(0x000C) (CPF_Edit, CPF_IsPlainOldData)
};
...
{
	class Vector2D                                     Vector;                                                   // 0x0048(0x0008) (CPF_Edit, CPF_IsPlainOldData)
};
...
struct FMovieSceneCameraCutSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      bHasCutTransform : 1;                                     // 0x0060(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	unsigned char                                      bTemporarilyHiddenInGame : 1;                             // 0x00B0(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
