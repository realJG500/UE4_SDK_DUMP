...
{
public:
	unsigned char                                      bEnableSpriteAtlasGroups : 1;                             // 0x0028(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      bEnableTerrainSplineEditing : 1;                          // 0x0029(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      bResizeSpriteDataToMatchTextures : 1;                     // 0x002A(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
...
public:
	...
	class Vector2D                                     SourceUV;                                                 // 0x0038(0x0008) (CPF_Edit, CPF_IsPlainOldData)
	class Vector2D                                     SourceDimension;                                          // 0x0040(0x0008) (CPF_Edit, CPF_IsPlainOldData)
	...
	class Vector2D                                     BakedSourceUV;                                            // 0x0060(0x0008) (CPF_IsPlainOldData)
	class Vector2D                                     BakedSourceDimension;                                     // 0x0068(0x0008) (CPF_IsPlainOldData)
...
{
public:
	unsigned char                                      bClosedSpline : 1;                                        // 0x0850(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bFilledSpline : 1;                                        // 0x0851(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      bUseSingleLayer : 1;                                      // 0x0994(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
