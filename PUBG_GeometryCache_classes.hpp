...
public:
	...
	unsigned char                                      bRunning : 1;                                             // 0x0958(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bLooping : 1;                                             // 0x0959(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      UnknownData00[0x54];                                      // 0x096C(0x0054) MISSED OFFSET
