...
enum class EMaskTarget_PhysMesh
{
...
struct FClothConfig
{
	unsigned char                                      UnknownData00[0x1];                                       // 0x0000(0x0001) UNKNOWN PROPERTY: EnumProperty ClothingSystemRuntime.ClothConfig.WindMethod
	...
	class Vector3D                                     Damping;                                                  // 0x0050(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	...
	class Vector3D                                     LinearDrag;                                               // 0x0068(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	class Vector3D                                     AngularDrag;                                              // 0x0074(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	class Vector3D                                     LinearInertiaScale;                                       // 0x0080(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	class Vector3D                                     AngularInertiaScale;                                      // 0x008C(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	class Vector3D                                     CentrifugalInertiaScale;                                  // 0x0098(0x000C) (CPF_Edit, CPF_IsPlainOldData)
...
{
	TArray<class Vector3D>                             Vertices;                                                 // 0x0000(0x0010) (CPF_Edit, CPF_ZeroConstructor)
	TArray<class Vector3D>                             Normals;                                                  // 0x0010(0x0010) (CPF_Edit, CPF_ZeroConstructor)
...
struct FClothParameterMask_PhysMesh
{
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0008(0x0001) UNKNOWN PROPERTY: EnumProperty ClothingSystemRuntime.ClothParameterMask_PhysMesh.CurrentTarget
